...
<div class="film-review">
  <header class="film-review__intro">
    ...
    <p>
      ReWord Nerd is a browser-only workbench that turns reviewed Text and Image inputs into
      model-tailored prompt packages. This review page collects a quick guide and two short
      product films.
    </p>
